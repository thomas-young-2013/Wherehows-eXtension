...
public enum EtlJobName {
  ...
  LHOTSE_EXECUTION_METADATA_ETL(EtlType.OPERATION, RefIdType.APP),
  OOZIE_EXECUTION_METADATA_ETL(EtlType.OPERATION, RefIdType.APP),
  HBASE_DATASET_METADATA_ETL(EtlType.DATASET, RefIdType.DB),
  ...
  LHOTSE_LINEAGE_METADATA_ETL(EtlType.LINEAGE, RefIdType.APP),
