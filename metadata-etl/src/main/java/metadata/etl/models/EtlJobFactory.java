...
import metadata.etl.lhotse.LzLineageMetaDataEtl;
...
public class EtlJobFactory {
  ...
  public static EtlJob getEtlJob(EtlJobName etlJobName, Integer refId, Long whExecId, Properties properties) {
    switch (etlJobName) {
      ...
      case LHOTSE_EXECUTION_METADATA_ETL:
        return new LhotseExecEtl(refId, whExecId, properties);
      ...
      case HBASE_DATASET_METADATA_ETL:
        return new HBaseMetadataEtl(refId, whExecId, properties);
      ...
      case LHOTSE_LINEAGE_METADATA_ETL:
        return new LzLineageMetaDataEtl(refId, whExecId, properties);
